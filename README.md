...
🔏 Edit your smart contract `TimedLottery.sol` in `packages/hardhat/contracts`
...
📚 Go through each topic from [solidity by example](https://solidity-by-example.org) editing `TimedLottery.sol` in **🏗 scaffold-eth**
